    ...
    public partial class MiscellaneousList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string a = "";
                a = MiscellaneousDataPager.PageSize.ToString();
        ...
        {
            int currentPage = (MiscellaneousDataPager.StartRowIndex / MiscellaneousDataPager.PageSize) + 1;
            int TotalPages = (int)Math.Ceiling(Convert.ToDecimal(MiscellaneousDataPager.TotalRowCount) / Convert.ToDecimal(MiscellaneousDataPager.PageSize));

            DropDownList ddlpageJump = (DropDownList)(MiscellaneousDataPager.Controls[0].FindControl("ddlPageJump"));
        ...
        protected void PageJump_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            int startRowIndex = (pageNo - 1) * MiscellaneousDataPager.PageSize;

            MiscellaneousDataPager.SetPageProperties(startRowIndex, MiscellaneousDataPager.PageSize, true);
            recalcNoOfPages();
