<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaint/LoggedIn.Master" AutoEventWireup="true" CodeBehind="DMS_MiscellaneousList.aspx.cs" Inherits="UserSec.DMS.MiscellaneousList" %>
            ...
            <Fields>
                <asp:TemplatePagerField>
                    <PagerTemplate>
                        ...
                        of
                        <asp:Label ID="TotalPageNoLabel" runat="server" Text="<%#(int) Math.Ceiling(Convert.ToDecimal(MiscellaneousDataPager.TotalRowCount) / Convert.ToDecimal(MiscellaneousDataPager.PageSize)) %>" >
                        </asp:Label>
                    </PagerTemplate>
                </asp:TemplatePagerField>
