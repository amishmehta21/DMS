<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaint/LoggedIn.Master" AutoEventWireup="true"
    CodeBehind="DMS_DocumentList.aspx.cs" Inherits="UserSec.DMS.DocumentList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cpMainPage" runat="server">

<div><strong>Select No. of Records per page</strong> &nbsp; &nbsp;
    ...
    <div>
        <asp:ListView ID="LvDocumentItems" runat="server" ItemPlaceholderID="layoutTemplate"
            OnItemDeleting="LvDocumentItems_ItemDeleting" DataKeyNames="DocId" InsertItemPosition="LastItem"
            OnPagePropertiesChanging="ListViewDocument_PagePropertiesChanging" OnItemEditing="LvDocumentItems_ItemEditing"
            OnItemUpdating="LvDocumentItems_ItemUpdating" OnItemCanceling="LvDocumentItems_Canceling">
            <ItemTemplate>
        ...
        <asp:DataPager runat="server" ID="DocumentDataPager" PageSize="3" PagedControlID="LvDocumentItems">
            <Fields>
                <asp:TemplatePagerField>
                    <PagerTemplate>
                        ...
                        of
                        <asp:Label ID="TotalPageNoLabel" runat="server" Text="<%#(int) Math.Ceiling(Convert.ToDecimal(DocumentDataPager.TotalRowCount) / Convert.ToDecimal(DocumentDataPager.PageSize)) %>" >
                        </asp:Label>
                    </PagerTemplate>
                </asp:TemplatePagerField>
