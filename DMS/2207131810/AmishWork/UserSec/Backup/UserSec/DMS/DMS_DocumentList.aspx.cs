    ...
    public partial class DocumentList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                BindDocumentList();
                string a = "";
                a = DocumentDataPager.PageSize.ToString();
        ...
        {
            int currentPage = (DocumentDataPager.StartRowIndex / DocumentDataPager.PageSize) + 1;
            int TotalPages = (int)Math.Ceiling(Convert.ToDecimal(DocumentDataPager.TotalRowCount) / Convert.ToDecimal(DocumentDataPager.PageSize));

            DropDownList ddlpageJump = (DropDownList)(DocumentDataPager.Controls[0].FindControl("ddlPageJump"));
        ...
        protected void PageJump_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            int startRowIndex = (pageNo - 1) * DocumentDataPager.PageSize;

            DocumentDataPager.SetPageProperties(startRowIndex, DocumentDataPager.PageSize, true);
            recalcNoOfPages();
        ...
        protected void ListViewDocument_PagePropertiesChanging(object sender, PagePropertiesChangingEventArgs e)
        {
            ...
            this.DocumentDataPager.SetPageProperties(e.StartRowIndex, e.MaximumRows, false);
        ...
        protected void CurrentRowTextBox_OnTextChanged(object sender, EventArgs e)
        {
            ...
            DocumentDataPager.SetPageProperties(Convert.ToInt32(t.Text) - 1,
                DocumentDataPager.PageSize, true);
            BindDocumentList();
            recalcNoOfPages();
        }
        ...
        protected void OnPageSizeChange(object sender, EventArgs e)
        {
            ...
            {
                DocumentDataPager.PageSize = Convert.ToInt32(ddlPageSize.SelectedValue);
                BindDocumentList();
            }
            recalcNoOfPages();
        }
