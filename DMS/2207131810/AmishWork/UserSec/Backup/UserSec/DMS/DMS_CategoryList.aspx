<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaint/LoggedIn.Master" AutoEventWireup="true" CodeBehind="DMS_CategoryList.aspx.cs" Inherits="UserSec.CategoryList" %>
...
<div>
        ...
        <asp:DataPager runat="server" ID="CategoryDataPager" PageSize="3" PagedControlID="LvCategoryItems">
            <Fields>
                <asp:TemplatePagerField>
                    <PagerTemplate>
                        ...
                        of
                        <asp:Label ID="TotalPageNoLabel" runat="server" Text="<%#(int) Math.Ceiling(Convert.ToDecimal(CategoryDataPager.TotalRowCount) / Convert.ToDecimal(CategoryDataPager.PageSize)) %>" >
                        </asp:Label>
                    </PagerTemplate>
                </asp:TemplatePagerField>
