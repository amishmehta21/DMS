<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaint/LoggedIn.Master" AutoEventWireup="true" UICulture="es" culture="es-MX"
...
<div><strong>Select No. of Records</strong> &nbsp; &nbsp;
    ...
    <asp:DataPager runat="server" ID="UserDataPager" PageSize="3" PagedControlID="lvUserList">
        <Fields>
