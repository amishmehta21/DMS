<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaint/LoggedIn.Master" AutoEventWireup="true" CodeBehind="DMS_SubCategoryList.aspx.cs" Inherits="UserSec.DMS.SubCategoryList" %>
...
<div>
     <asp:ListView ID="LvSubCategoryItems" runat="server" ItemPlaceholderID="layoutTemplate" OnItemDeleting="LvSubCategoryItems_ItemDeleting"
            ...
            OnItemCommand="lvItemRowCommand">
            <ItemTemplate>
        ...
        <asp:DataPager runat="server" ID="SubCategoryDataPager" PageSize="3" PagedControlID="LvSubCategoryItems">
            <Fields>
                <asp:TemplatePagerField>
                    <PagerTemplate>
                        ...
                        of
                        <asp:Label ID="TotalPageNoLabel" runat="server" Text="<%#(int) Math.Ceiling(Convert.ToDecimal(SubCategoryDataPager.TotalRowCount) / Convert.ToDecimal(SubCategoryDataPager.PageSize)) %>" >
                        </asp:Label>
                    </PagerTemplate>
                </asp:TemplatePagerField>
