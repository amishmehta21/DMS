...
namespace UserSecDAL
{
    public class RoleAccessRightsDAL
    {
        ...
        public bool SaveRoleAccessRightDetails(RoleAccessRightsBE roleAccessBE)
        {
            ...
            cmd.Parameters.Add("@AddRec", SqlDbType.Int).Value = roleAccessBE.AddRec;
            cmd.Parameters.Add("@DeleteRec", SqlDbType.Int).Value = roleAccessBE.DeleteRec;
            cmd.Parameters.Add("@ModifyRec", SqlDbType.Int).Value = roleAccessBE.ModifyRec;
            cmd.Parameters.Add("@ViewRec", SqlDbType.Int).Value = roleAccessBE.ViewRec;
            cmd.Parameters.Add("@PrintRec", SqlDbType.Int).Value = roleAccessBE.PrintRec;
            cmd.Parameters.Add("@Search", SqlDbType.Int).Value = roleAccessBE.Search;
            cmd.Parameters.Add("@Approve", SqlDbType.Int).Value = roleAccessBE.Approve;
