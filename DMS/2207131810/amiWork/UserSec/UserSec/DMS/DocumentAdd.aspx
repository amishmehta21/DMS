<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaint/LoggedIn.Master" AutoEventWireup="true" CodeBehind="DocumentAdd.aspx.cs" Inherits="UserSec.DMS.DocumentAdd" %>
          ...
          <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="valCatId" runat="server" 
                        ...
                        ErrorMessage="This Field cannot be blank" SetFocusOnError="True" 
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="valSubCatId" runat="server" 
                        ControlToValidate="ddlSubCatId" ErrorMessage="RequiredFieldValidator" 
